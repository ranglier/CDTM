...
Une couche raster de secours limitee aux zooms bas reste prechargee au repos
avec une opacite quasi nulle. Elle devient opaque pendant les mouvements, puis
redevient invisible peu apres `moveend`, afin de garder des motifs visibles si
une tuile fine arrive en retard.
Sur mobile, cette couche de secours est desactivee par defaut afin de privilegier
la fluidite. Les routes publiques sont egalement masquees au premier affichage
mobile, tout en restant activables depuis le menu et via la recherche.
