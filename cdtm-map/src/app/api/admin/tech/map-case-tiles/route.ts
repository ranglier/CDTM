...
import { getMapCaseTileAdminStatus } from "@/server/map-case-tile-repository";
...
export async function GET(request: NextRequest) {
  ...
  try {
    const status = await getMapCaseTileAdminStatus();
    ...
    const message =
      error instanceof Error
        ? error.message
        : "Lecture des tuiles de cases impossible.";
